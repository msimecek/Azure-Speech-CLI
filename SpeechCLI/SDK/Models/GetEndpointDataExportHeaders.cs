...
namespace CRIS.Models
{
    ...
    public partial class GetEndpointDataExportHeaders
    {
        ...
        public GetEndpointDataExportHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
