...
namespace CRIS.Models
{
    ...
    public partial class UpdateEndpointHeaders
    {
        ...
        public UpdateEndpointHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
