...
namespace CRIS.Models
{
    ...
    /// </summary>
    public partial class DeleteEndpointDataHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteEndpointDataHeaders class.
        /// </summary>
        public DeleteEndpointDataHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteEndpointDataHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
