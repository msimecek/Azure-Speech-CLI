...
namespace CRIS.Models
{
    ...
    public partial class CreateAccuracyTestHeaders
    {
        ...
        public CreateAccuracyTestHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string), int? retryAfter = default(int?))
        {
