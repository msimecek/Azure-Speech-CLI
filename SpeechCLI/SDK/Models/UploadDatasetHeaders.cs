...
namespace CRIS.Models
{
    ...
    /// </summary>
    public partial class UploadDatasetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UploadDatasetHeaders class.
        /// </summary>
        public UploadDatasetHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public UploadDatasetHeaders(string location = default(string), string operationLocation = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
