...
namespace CRIS.Models
{
    ...
    public partial class GetEndpointDataExportsHeaders
    {
        ...
        /// UTC.</param>
        public GetEndpointDataExportsHeaders(int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
