...
namespace CRIS.Models
{
    ...
    public partial class CreateEndpointHeaders
    {
        ...
        /// UTC.</param>
        public CreateEndpointHeaders(string location = default(string), string operationLocation = default(string), int? retryAfter = default(int?), int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
            Location = location;
