...
namespace CRIS.Models
{
    ...
    /// </summary>
    public partial class GetHealthStatusHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetHealthStatusHeaders class.
        /// </summary>
        public GetHealthStatusHeaders()
        {
            CustomInit();
        }
        ...
        /// UTC.</param>
        public GetHealthStatusHeaders(int? xRateLimitLimit = default(int?), int? xRateLimitRemaining = default(int?), string xRateLimitReset = default(string))
        {
